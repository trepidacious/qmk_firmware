...
/*
 * Setup for Adafruit Feather Express STM32F405 board.
 */

/*
 * Board identifier.
 */
#define BOARD_ADAFRUIT_FEATHER_EXPRESS
#define BOARD_NAME                  "Adafruit Feather Express STM32F405"
...
#define LINE_TX_D1                  PAL_LINE(GPIOB, 10U)
#define LINE_RX_D0                  PAL_LINE(GPIOB, 11U)
...
#define LINE_D8_NEOPIX              PAL_LINE(GPIOC, 0U)
 ...
 * PA15 - FLASH_CS                  (input pullup).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PIN0) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOA_PIN2) |           \
                                     PIN_MODE_INPUT(GPIOA_V_DIV) |          \
 ...
 * PB3  - FLASH_SCK                 (input pullup).
 * PB4  - FLASH_MISO                (input pullup).
 * PB5  - FLASH_MOSI                (input pullup).
 * PB6  - SCL                       (input pullup).
 * PB7  - SDA                       (input pullup).
 * PB8  - D9                        (input pullup).
 * PB9  - D10                       (input pullup).
 * PB10 - TX_D1                     (input pullup).
 * PB11 - RX_D0                     (input pullup).
 * PB12 - SD_DETECT                 (input pullup).
 * PB13 - SCK                       (input pullup).
 * PB14 - MISO                      (input pullup).
 * PB15 - MOSI                      (input pullup).
 */
#define VAL_GPIOB_MODER             (PIN_MODE_INPUT(GPIOB_PIN0) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN1) |           \
                                     PIN_MODE_INPUT(GPIOB_PIN2) |           \
                                     PIN_MODE_INPUT(GPIOB_FLASH_SCK) |      \
                                     PIN_MODE_INPUT(GPIOB_FLASH_MISO) |     \
                                     PIN_MODE_INPUT(GPIOB_FLASH_MOSI) |     \
                                     PIN_MODE_INPUT(GPIOB_SCL) |            \
                                     PIN_MODE_INPUT(GPIOB_SDA) |            \
                                     PIN_MODE_INPUT(GPIOB_D9) |             \
                                     PIN_MODE_INPUT(GPIOB_D10) |            \
                                     PIN_MODE_INPUT(GPIOB_TX_D1) |          \
                                     PIN_MODE_INPUT(GPIOB_RX_D0) |          \
                                     PIN_MODE_INPUT(GPIOB_SD_DETECT) |      \
                                     PIN_MODE_INPUT(GPIOB_SCK) |            \
                                     PIN_MODE_INPUT(GPIOB_MISO) |           \
                                     PIN_MODE_INPUT(GPIOB_MOSI))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) |       \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_TX_D1) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOB_RX_D0) |      \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_PIN0) |          \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_TX_D1) |         \
                                     PIN_OSPEED_HIGH(GPIOB_RX_D0) |         \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_TX_D1) |        \
                                     PIN_PUPDR_PULLUP(GPIOB_RX_D0) |        \
                                     PIN_PUPDR_PULLUP(GPIOB_SD_DETECT) |    \
                                     PIN_PUPDR_PULLUP(GPIOB_SCK) |          \
                                     PIN_PUPDR_PULLUP(GPIOB_MISO) |         \
                                     PIN_PUPDR_PULLUP(GPIOB_MOSI))
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_PIN0) |             \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_TX_D1) |            \
                                     PIN_ODR_HIGH(GPIOB_RX_D0) |            \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_PIN0, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOB_FLASH_SCK, 0U) |     \
                                     PIN_AFIO_AF(GPIOB_FLASH_MISO, 0U) |    \
                                     PIN_AFIO_AF(GPIOB_FLASH_MOSI, 0U) |    \
                                     PIN_AFIO_AF(GPIOB_SCL, 0U) |           \
                                     PIN_AFIO_AF(GPIOB_SDA, 0U))
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_D9, 0U) |            \
                                     PIN_AFIO_AF(GPIOB_D10, 0U) |           \
                                     PIN_AFIO_AF(GPIOB_TX_D1, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_RX_D0, 0U) |         \
                                     PIN_AFIO_AF(GPIOB_SD_DETECT, 0U) |     \
                                     PIN_AFIO_AF(GPIOB_SCK, 0U) |           \
                                     PIN_AFIO_AF(GPIOB_MISO, 0U) |          \
                                     PIN_AFIO_AF(GPIOB_MOSI, 0U))

/*
 * GPIOC setup:
 *
 * PC0  - D8_NEOPIX                 (input pullup).
 ...
 * PC6  - D6                        (input pullup).
 * PC7  - D5                        (input pullup).
 * PC8  - SDIO_D0                   (input pullup).
 * PC9  - SDIO_D1                   (input pullup).
 * PC10 - SDIO_D2                   (input pullup).
 * PC11 - SDIO_D3                   (input pullup).
 * PC12 - SDIO_CLK                  (input pullup).
 * PC13 - PIN13                     (input pullup).
 * PC14 - OSC32_IN                  (input floating).
 * PC15 - OSC32_OUT                 (input floating).
 */
#define VAL_GPIOC_MODER             (PIN_MODE_INPUT(GPIOC_D8_NEOPIX) |      \
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_D8_NEOPIX) |  \
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_D8_NEOPIX) |     \
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_PULLUP(GPIOC_D8_NEOPIX) |    \
...
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_D8_NEOPIX) |        \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_D8_NEOPIX, 0U) |     \

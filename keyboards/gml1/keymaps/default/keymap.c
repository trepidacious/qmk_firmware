...
[0] = LAYOUT(
  ...
  LCTL(LSFT(KC_P)), KC_LCTL, KC_LALT, KC_LGUI, MO(1),   KC_SPC,  KC_SPC,  MO(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[1] = LAYOUT(
  ...
  RESET,   _______, _______, _______, _______, _______,  _______, _______, KC_HOME, KC_PGDOWN, KC_PGUP, KC_END
),

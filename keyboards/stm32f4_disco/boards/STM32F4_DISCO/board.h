...
/*
 * Setup for STMicroelectronics STM32F4-Discovery QMK Keyboard board.
 */

/*
 * Board identifier.
 */
#define BOARD_STM32F4_DISCO
#define BOARD_NAME                  "STMicroelectronics STM32F4-Discovery QMK Keyboard"
